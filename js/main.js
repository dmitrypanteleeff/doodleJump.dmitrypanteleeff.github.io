        ...
        if (!isGameOver){
            ...
            document.addEventListener('touchmove', function (event) {
                ...
                if (Math.abs(otk.x) > 100) {
                    if (otk.x < 0) { gridTest.innerHTML = "свайп влево"; moveLeft();/*СВАЙП ВЛЕВО(ПРЕД.СТРАНИЦА)*/ }
                    if (otk.x > 0) { gridTest.innerHTML = "свайп вправо"; moveRight();/*СВАЙП ВПРАВО(СЛЕД.СТРАНИЦА)*/ }
            ...
            document.addEventListener('touchend', function (event) {
                ...
                if ((xAbs > 20 || yAbs > 20) && (pdelay.getTime() - ldelay.getTime()) < 200) {
                    if (xAbs > yAbs) {
                        if (nowPoint.pageX < startPoint.x) {gridTest.innerHTML = "свайп влево"; moveLeft();/*СВАЙП ВЛЕВО*/ }
                        else {gridTest.innerHTML = "свайп вправо"; moveRight();/*СВАЙП ВПРАВО*/ }
                    }
                    else {
                        if (nowPoint.pageY < startPoint.y) {gridTest.innerHTML = "свайп вверх"; moveStraight();/*СВАЙП ВВЕРХ*/ }
                        else {/*СВАЙП ВНИЗ*/ }
                    }
                }
            }, false);
